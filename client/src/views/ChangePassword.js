    ...
    <Flex bgColor='gray.800' height='100vh' justifyContent='center' alignItems='center'>
      {
        error.length ? (
          <Flex borderRadius={15} bgColor='gray.100' p={5} width='20%' justifyContent='center' alignItems='center' flexDirection='column'>
            ...
            <Text marginBottom={2} color='gray.800' fontSize='xl'>Error occurred!</Text>
            <Text marginBottom={2} fontWeight="light" fontFamily="calibri" fontSize="md" color="gray.600" textAlign="center">
              { error.join(', ') }
            </Text>
            <Link marginTop={2} display='flex' alignItems='center' as={RouterLink} to='/forgot-password' fontFamily='calibri' fontWeight='light' color='gray.500' _hover={{ textDecoration: 'none' }}>
          ...
          !success ?
            <Flex borderRadius={15} bgColor='gray.100' p={5} width='20%' justifyContent='center' alignItems='center' flexDirection='column'>
              ...
              <form style={{ width: '100%' }}>
                ...
                <Button isLoading={isWaiting} disabled={(pass.pass1 !== pass.pass2) || !pass.pass1 ? true: false} type='submit' width='100%' fontFamily='calibri' fontWeight='light' colorScheme='teal' onClick={clickSubmit}>SUBMIT</Button>
              </form>
              <Flex marginTop={3}>
            ...
            <Flex borderRadius={15} bgColor='gray.100' p={5} width='20%' justifyContent='center' alignItems='center' flexDirection='column'>
              ...
              <Text marginBottom={2} color='gray.800' fontSize='xl'>Nice!</Text>
              <Text marginBottom={2} fontWeight="light" fontFamily="calibri" fontSize="lg" color="gray.600" textAlign="center">
                {success}
              </Text>
              <Link display='flex' alignItems='center' as={RouterLink} to='/login' fontFamily='calibri' fontWeight='light' color='gray.500' _hover={{ textDecoration: 'none' }}>
                <ArrowBackIcon marginRight={1} />

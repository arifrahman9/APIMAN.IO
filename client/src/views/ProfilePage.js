...
export default function ProfilePage() {
  ...
  return (
    <Flex h="100vh" flexDir="column">
      ...
      <Flex bgColor="gray.800" alignItems="center" width="100vw" position="relative" py={2} px={1}>
        {/* Left container */}
        <Flex width="50%" minHeight="100%" position="static" top={0} left={0} px={1}>
        ...
        {/* Right container */}
        <Flex width="50%" minHeight="100%" position="static" top={0} right={0} px={1}>
          <CollectionInProfile />
        </Flex>
      </Flex>
    </Flex>
